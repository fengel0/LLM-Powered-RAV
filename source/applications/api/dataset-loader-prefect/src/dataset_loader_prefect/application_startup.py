...
from dataset_loader_prefect.settings import API_NAME, API_VERSION

logger = logging.getLogger(__name__)


class ApplicationDatasetloader(Application):
    ...
    def _add_components(self):
        ...
        )._with_acomponent(component=PostgresStartupSequence(models=[models]))
